...
import {BasketItems} from "../content/basket/BasketItems";
import {clearItems, SelectBasketItem} from "../../redux/slices/basketSlice";
import { FC } from "react";
import { BasketEmpty } from "../content/basket/BasketEmpty";
    ...
    return (
        ...
        <div className="cart">
            <div className="cart__top">
                ...
                <div onClick={basketClear} className="cart__clear">
            ...
            <div className="cart__bottom">
                ...
                <div className="cart__bottom-buttons">
                    <Link to='pizza-react/' className="button button--outline button--add go-back-btn">
